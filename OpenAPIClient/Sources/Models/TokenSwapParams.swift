...
public struct TokenSwapParams: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        tokenIn = try container.decode(String.self, forKey: .tokenIn)
        tokenOut = try container.decode(String.self, forKey: .tokenOut)
        tokenInDecimals = try container.decode(Double.self, forKey: .tokenInDecimals)
        tokenOutDecimals = try container.decode(Double.self, forKey: .tokenOutDecimals)
        amountIn = try container.decode(String.self, forKey: .amountIn)
        slippage = try container.decode(String.self, forKey: .slippage)
        recipient = try container.decode(String.self, forKey: .recipient)
        referrer = try container.decode(String.self, forKey: .referrer)
    }
