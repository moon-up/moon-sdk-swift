...
public struct AaveInput: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        lendingPool = try container.decodeIfPresent(String.self, forKey: .lendingPool)
        amount = try container.decodeIfPresent(String.self, forKey: .amount)
        atokenToRedeeem = try container.decodeIfPresent(String.self, forKey: .atokenToRedeeem)
        refCode = try container.decodeIfPresent(String.self, forKey: .refCode)
        interestRateMode = try container.decodeIfPresent(String.self, forKey: .interestRateMode)
    }
