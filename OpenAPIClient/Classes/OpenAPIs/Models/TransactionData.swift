...
public struct TransactionData: Codable, JSONEncodable, Hashable {
    ...
    public init(moonScanUrl: String? = nil, transactionHash: String, signedTransaction: String, signedMessage: String? = nil, rawTransaction: String? = nil, signature: String? = nil, transaction: Tx? = nil, userOps: [TransactionRequest]? = nil, useropTransaction: String? = nil) {
